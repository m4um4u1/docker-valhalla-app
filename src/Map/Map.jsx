...
import './Map.css'
const OSMTiles = L.tileLayer(window.env.REACT_APP_TILE_SERVER_URL, {
  attribution:
...
const centerCoords = window.env.REACT_APP_CENTER_COORDS.split(',')
...
const maxBoundsString = window.env.REACT_APP_MAX_BOUNDS?.split(',')
